...
test('Ostkreuz travel reverses continuously and preserves the chosen city composition',async({page})=>{
 ...
 // Resolve the lazy module before freezing timers used by React Suspense.
 ...
 await expect(page.getByTestId('interchange-travel')).toHaveCount(0)
 await page.emulateMedia({reducedMotion:'no-preference'})
 await page.clock.pauseAt(new Date('2026-09-07T08:05:00Z'))
 ...
 await page.getByTestId('ostkreuz-scene').waitFor({state:'attached'})
